...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <form action="{{ route('product.store') }}" method="post" class="bg-white p-8 rounded-lg shadow-lg border border-gray-200 w-full max-w-lg space-y-6">
        @csrf

        <h2 class="text-2xl font-semibold text-gray-800 text-center mb-4 uppercase">Create New Product</h2>
